const columns = {
  ...
  keyHistory: {header: 'Key History', title: 'Is it possible to retain and obtain the history of keys related to a certain identifier?'},
  keyRotation: {header: 'Key Rotation', title: 'Can the key referred to in a credential can be replaced by a new key?'},
